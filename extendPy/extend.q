...
.py.__file__: {first -3# value[.z.s]}[];
searchPath:(getenv `KDB_EXTENDPY_DIR; raze (system "dirname ",.py.__file__); getenv `QHOME)except (enlist "")
depDirs:searchPath where {"reflect.p" in system "ls ",x} each searchPath

$[not count depDirs;'
-1 "DependencyError: [extendPy] cannot locate required file: 'reflect.p'"
]
